    ...
    <article className="mx-auto max-w-3xl px-4 py-12 space-y-10">
      ...
      <section>
        ...
        <p className="mt-4 text-[var(--ink)]/80 leading-relaxed">
          Ontario Taraweeh Outreach is a dedicated initiative created to connect Huffadh, Imams, Ulamaa, and Quraan teachers with Masajid, Musallahs, and Madaris across Ontario and throughout North America.
          <br /><br />
